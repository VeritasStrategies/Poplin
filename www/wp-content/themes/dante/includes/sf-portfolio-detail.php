		...
		?>
			<div class="share-links clearfix">
				<ul class="bar-styling">
				    ...
				    <li class="facebook"><a href="http://www.facebook.com/sharer.php?u=<?php $page_permalink; ?>" class="product_share_facebook" onclick="javascript:window.open(this.href,
				      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=220,width=600');return false;"><i class="fa-facebook"></i></a></li>
				    <li class="twitter"><a href="https://twitter.com/share?url=<?php $page_permalink; ?>&text=<?php echo urlencode(get_the_title()); ?>" onclick="javascript:window.open(this.href,
				    ...
				    <li class="google-plus"><a href="https://plus.google.com/share?url=<?php $page_permalink; ?>" onclick="javascript:window.open(this.href,
				      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa-google-plus"></i></a></li>
				    <?php if ($share_image_url != "") { ?>
				    <li class="pinterest"><a href="//pinterest.com/pin/create/button/?url=<?php $page_permalink; ?>&media=<?php echo $share_image_url; ?>&description=<?php echo $page_title; ?>" onclick="javascript:window.open(this.href,
				    ...
				    <?php } else { ?>
				    <li class="pinterest"><a href="//pinterest.com/pin/create/button/?url=<?php $page_permalink; ?>&description=<?php echo $page_title; ?>" onclick="javascript:window.open(this.href,
				      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=320,width=600');return false;" class="product_share_pinterest"><i class="fa-pinterest"></i></a></li>
				    <?php } ?>
